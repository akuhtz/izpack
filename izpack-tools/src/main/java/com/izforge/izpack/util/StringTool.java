...
public class StringTool
{
     ...
     *
     * @param aPathString         The input string in which the white space should be handled.
     * @param replaceOrEscapeWith The Replace or Escape Char Interpreted depended on the escape Flag
     * @param replaceWhat         The string array with the Characters, which should be replaced
     * @param escape              The flag, which indicates, how to handle the given replaceOrEscapeWith String.
     * @return the escaped path
     */
     ...
     *
     * @param destination the input to normalize
     ...
     *
     * @param aStringList the list to transform
